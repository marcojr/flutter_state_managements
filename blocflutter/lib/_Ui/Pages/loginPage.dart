          ...
          children: [
            ...
            Container(
              ...
              child: customInputBox(
                  ...
                  isPassword: false,
                  isDisabled:
                      state.loginStatus == LoginStatus.LOGIN_IN_PROGRESS),
            ),
            Container(
              padding: EdgeInsets.only(left: 30, right: 30),
            ...
            GestureDetector(
              onTap: () async {
                context.read<UserBloc>().add(UserEvent(
                    ctrUsername.text, ctrPassword.text, UserActions.LOGIN));
              },
              child: Container(
                  decoration: BoxDecoration(
                  ...
                  child: Center(
                    child: state.loginStatus == LoginStatus.LOGIN_IN_PROGRESS
